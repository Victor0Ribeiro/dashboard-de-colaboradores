    ...
    function updateDashboard() {
        ...
        selectedEmployees.forEach(emp => {
            ...
            tr.innerHTML = `
                ...
                <td>${emp.Área || '-'}</td>
                <td>${emp.Paciência}</td>
                <td>${emp.Versatilidade}</td>
                <td>${emp.Comunicação}</td>
            `;
        ...
        const datasets = selectedEmployees.map((emp, idx) => {
            ...
            return {
                label: emp.Nome,
                data: [emp.Paciência, emp.Versatilidade, emp.Comunicação],
        ...
        const data = { labels: ['Paciência', 'Versatilidade', 'Comunicação'], datasets };
        const options = {
